...
$err = [];
 ...
 if(isset($_POST['name'])){
    ...
    if(empty($address)){
     ...
     $sql = "INSERT INTO users(name, email, password, phone, address) VALUES('$name', '$email', '$pass', '$phone', '$address')";
     $query = mysqli_query($conn, $sql);
     if($query){
         header('location: login.php'); //để chuyển sang trang dangnhap
     }
     }
     //die();
 }
            ...
            <!-- Header with search -->
                ...
                <a href="./index.php"class="header__logo">
                    ...
                    <div class="header__search-cart">
                        <span class="header__search-cart--span">Đăng ký</span>
                    </div>
            ...
            <div class="app__container">
                <div class="grid">
                    ...
                    <form action="#" method="POST" role="form">
                        ...
                        <a href="login.php" class="auth-form__switch-btn"><span class="auth-form__switch-btn">Đăng nhập</span></a>
                        </div>

                        <div class="auth-form__form">
                            <div class="auth-form__group">
                                <input type="text" class="auth-form__input" placeholder="Tên" name="name">
                                                            <!--show lỗi-->
                            <div class="has-error">
                        ...
                        <div class="auth-form__form">
                            ...
                            <div class="auth-form__group">
                                <input type="password" class="auth-form__input" placeholder="Nhập lại mật khẩu" name="rpassword">
                                <div class="has-error">
